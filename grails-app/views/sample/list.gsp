...
<div id="list-sample" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="food" title="${message(code: 'sample.food.label', default: 'Food')}"/>
        ...
        <g:each in="${sampleInstanceList}" status="i" var="sampleInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${sampleInstance.id}">${fieldValue(bean: sampleInstance, field: "food")}</g:link></td>
